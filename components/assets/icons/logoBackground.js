...
const LogoBackground = (props) => (
  <svg width={props.width || CAP_SPACE_32} height={props.height || CAP_SPACE_32} viewBox="0 0 32 32">
    <defs>
    ...
    <use fill={props.fill || CAP_G07} fillRule="evenodd" transform="translate(-1487 -816)" xlinkHref="#a" />
  </svg>
);
