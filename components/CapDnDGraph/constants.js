export const CUSTOM_EDGE = 'CUSTOM_EDGE';
export const CUSTOM_EDGE_DASHED = 'CUSTOM_EDGE_DASHED';

export const GRAPH_LAYOUT_TYPE = 'dagre';
...
export const SCHEDULE_BLOCK = 'SCHEDULE_BLOCK';
