      ...
      <div className="cap-icon-info">
        <div className="cap-icon-showcase">
          ...
          <ul className="cap-icons-list">
            ...
            <List>
              <CapIcon type="circle-dollar" />
              <Text>circle-dollar</Text>
            </List>
            <List>
              <CapIcon type="academy" />
              <Text>academy</Text>
            </List>
            <List>
              <CapIcon type="headphone" />
              <Text>headphone</Text>
            </List>
            <List>
            ...
            <List>
              <CapIcon type="loyalty-background" />
              <Text>loyalty-background</Text>
            </List>
            <List>
              <CapIcon type="rcs" />
              <Text>rcs</Text>
            ...
            <List>
              <CapIcon type="draft-failed" />
              <Text>draft-failed</Text>
            </List>
            <List>
